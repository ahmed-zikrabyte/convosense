          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-green-600">
                {metrics.campaigns.published} published
              </span>{" "}
              •
              <span className="text-gray-600">
                {metrics.campaigns.draft} draft
              </span>
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {metrics.calls.totalCalls.toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
              <span className="text-green-600">
                {metrics.calls.successRate}% success rate
              </span>
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-2">
              <Progress
                value={
                  (metrics.credits.usedMinutes / metrics.credits.totalMinutes) *
                  100
                }
                className="h-2"
              />
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {metrics.credits.remainingMinutes.toLocaleString()} minutes
              remaining
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-semibold">
                ${metrics.performance.avgCallCost}
              </span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold">
                {metrics.credits.monthlyUsage} min
              </span>
            </div>
          </CardContent>
        </Card>
